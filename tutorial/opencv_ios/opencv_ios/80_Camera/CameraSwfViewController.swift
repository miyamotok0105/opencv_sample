...
class CameraSwfViewController: UIViewController, AVCaptureVideoDataOutputSampleBufferDelegate,UIGestureRecognizerDelegate {
    ...
    func captureImage(_ sampleBuffer:CMSampleBuffer) -> UIImage{
        ...
        resultImage = outputImage(originalImage: resultImage, filter: CIFilter(name: "CIPhotoEffectInstant"))
